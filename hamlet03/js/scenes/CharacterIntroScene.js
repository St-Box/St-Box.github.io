        ...
        this.template = `
            <div class="character-intro-scene">
                <div class="intro-header">
                    <h1>Characters</h1>
                    <p class="intro-subtitle">In the world of quantum superposition, each character follows their own trajectory of destiny…</p>
                </div>
                ...
                <div class="navigation-buttons character-nav-buttons"> <!-- 添加特定类名 -->
                    <button class="nav-button character-nav-button back-btn"> <!-- 添加特定类名 -->
                        <span class="button-icon">←</span>
                        <span class="button-text">Back</span>
                    </button>
                    <button class="nav-button character-nav-button start-btn"> <!-- 添加特定类名 -->
